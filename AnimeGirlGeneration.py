...
Original file is located at
    https://colab.research.google.com/drive/1wzv7x1J8nfi7rxfhtThXPgmxIYEu-ej2
...
workspace_dir = '/content/drive/MyDrive/ML2021/homework6'
...
if os.path.exists(workspace_dir):
    print(f"Directory contents of '{workspace_dir}':")
    for item in os.listdir(workspace_dir):
        print(item)
else:
    print(f"Error: Directory '{workspace_dir}' does not exist or is not mounted.")
'''
...
class Discriminator(nn.Module):
    ...
    def __init__(self, in_dim, dim=64):
        ...
        self.ls = nn.Sequential(
            spectral_norm(nn.Conv2d(in_dim, dim, 5, 2, 2)), #GAN中常用spetral_norm來控制discriminator對於input的敏感度
            nn.LeakyReLU(0.2),
    ...
    def forward(self, x):
        y = self.ls(x)
        y = y.view(-1) #-1 作為 view 的一個參數表示該維度的大小由 PyTorch 自動推斷，以保證元素的總數不變。
        return y
